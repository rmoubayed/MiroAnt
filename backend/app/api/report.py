...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this endpoint to get already-generated section content
...
def get_console_log(report_id: str):
    ...
    Retrieves console output (INFO, WARNING, etc.) in real-time during report generation.
