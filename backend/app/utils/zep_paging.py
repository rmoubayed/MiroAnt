...
def fetch_all_nodes(
    ...
    """Fetch graph nodes with pagination, returning up to max_items (default 2000). Each page request has built-in retries."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Fetch all graph edges with pagination, returning the complete list. Each page request has built-in retries."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
