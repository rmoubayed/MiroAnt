...
This script reads parameters from a configuration file to run simulations, fully automated.
...
# Add filter immediately at module load time to take effect before camel code executes
