            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After document upload, the LLM analyzes content and automatically generates an ontology structure suitable for public opinion simulation (entity types + relationship types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunk documents and call the Zep API to build a knowledge graph and extract entities and relationships
                </div>
              </div>
