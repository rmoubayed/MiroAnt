    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are chunked automatically and sent to Zep to build the knowledge graph, extract entities and relationships, and produce temporal memory and community summaries.
          </p>
