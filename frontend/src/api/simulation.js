 ...
 * @param {string} simulationId
 * @returns {Promise} Returns config details including metadata and content
 */
 ...
 * @param {string} projectId - optional, filtered by project ID
 */
...
/**
 * Get simulation timeline (grouped by rounds)
 * @param {string} simulationId
